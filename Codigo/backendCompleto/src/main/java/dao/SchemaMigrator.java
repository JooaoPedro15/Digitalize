    ...
    public static void migrate()
    {
        ...
        try
        {
            ...
            try (Statement st = c.createStatement())
            {
                ...
                st.execute("CREATE TABLE IF NOT EXISTS canal (" +
                ...
                st.execute("CREATE TABLE IF NOT EXISTS importacao (" +
                           ...
                           "importacao_status VARCHAR(12) NOT NULL DEFAULT 'PENDENTE' CHECK (importacao_status IN ('PENDENTE','PROCESSADA','FALHA')), " +
                ...
                st.execute("CREATE TABLE IF NOT EXISTS post (" +
                           "canal_id BIGINT NOT NULL REFERENCES canal(canal_id) ON DELETE CASCADE, " +
